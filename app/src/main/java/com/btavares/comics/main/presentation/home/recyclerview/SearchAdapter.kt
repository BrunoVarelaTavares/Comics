...
internal class SearchAdapter: RecyclerView.Adapter<SearchAdapter.ViewHolder>() {
    ...
    internal inner class ViewHolder(
        ...
        fun bind(comicDataModel: ComicDomainModel) {
            itemView.tvSearchItemTitle.text = comicDataModel.title
            itemView.tvSearchItemNumber.text = comicDataModel.number.toString()
            itemView.ivSearchItemImage.load(comicDataModel.imageUrl)
